...
exports.setToc = function (model) {
    ...
    if (model._tocKey) {
        ...
        if (toc) {
            ...
            var relativeTocDir = model._rel + tocDir;

            normalize(toc, relativeTocDir, function (item) {
    ...
    if (model._navKey) {
        ...
        if (nav) {
            ...
            var relativeNavDir = model._rel + navDir;

            normalize(nav, relativeNavDir, function (item) {
